...
return this;}
	...
	private boolean isRightPressed(int keyCode) {
		return keyCode == org.eclipse.swt.SWT.ARROW_RIGHT;
	}

	private boolean isLeftPressed(int keyCode) {
		return keyCode == org.eclipse.swt.SWT.ARROW_LEFT;
	}
	
	private int getAbsX(Object widget, int x, int y) {
		org.eclipse.swt.graphics.Point absolutePos = ((org.eclipse.swt.widgets.Control) widget).toDisplay(x, y);
		int eventX = absolutePos.x;
		return eventX;
	}
}
