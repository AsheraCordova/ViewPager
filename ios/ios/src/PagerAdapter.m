...
//  source: D:\Java\git\core-ios-widgets\IOSViewPagerPlugin\src\main\java\androidx\viewpager\widget\PagerAdapter.java
//
...
J2OBJC_FIELD_SETTER(ASPagerAdapter, mObservable_, ADDataSetObservable *)
J2OBJC_FIELD_SETTER(ASPagerAdapter, mViewPagerObserver_, ADDataSetObserver *)

__attribute__((unused)) static IOSObjectArray *ASPagerAdapter__Annotations$0(void);

__attribute__((unused)) static IOSObjectArray *ASPagerAdapter__Annotations$1(void);

__attribute__((unused)) static IOSObjectArray *ASPagerAdapter__Annotations$2(void);

__attribute__((unused)) static IOSObjectArray *ASPagerAdapter__Annotations$3(void);

__attribute__((unused)) static IOSObjectArray *ASPagerAdapter__Annotations$4(void);

@implementation ASPagerAdapter
...
- (id)instantiateItemWithADView:(ADView *)container
                        withInt:(jint)position {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Required method instantiateItem was not overridden");
}

- (void)destroyItemWithADView:(ADView *)container
                      withInt:(jint)position
                       withId:(id)object {
  @throw new_JavaLangUnsupportedOperationException_initWithNSString_(@"Required method destroyItem was not overridden");
}
...
- (jint)getItemPositionWithId:(id)object {
  return ASPagerAdapter_POSITION_UNCHANGED;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "POSITION_UNCHANGED", "I", .constantValue.asInt = ASPagerAdapter_POSITION_UNCHANGED, 0x19, -1, -1, -1, -1 },
    { "POSITION_NONE", "I", .constantValue.asInt = ASPagerAdapter_POSITION_NONE, 0x19, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "startUpdate", "LADViewGroup;", "instantiateItem", "LADViewGroup;I", "destroyItem", "LADViewGroup;ILNSObject;", "setPrimaryItem", "finishUpdate", "LADView;", (void *)&ASPagerAdapter__Annotations$0, "LADView;I", (void *)&ASPagerAdapter__Annotations$1, "LADView;ILNSObject;", (void *)&ASPagerAdapter__Annotations$2, (void *)&ASPagerAdapter__Annotations$3, (void *)&ASPagerAdapter__Annotations$4, "isViewFromObject", "LADView;LNSObject;", "restoreState", "LADParcelable;LJavaLangClassLoader;", "getItemPosition", "LNSObject;", "registerDataSetObserver", "LADDataSetObserver;", "unregisterDataSetObserver", "setViewPagerObserver", "getPageTitle", "I", "getPageWidth" };
  static const J2ObjcClassInfo _ASPagerAdapter = { "PagerAdapter", "androidx.viewpager.widget", ptrTable, methods, fields, 7, 0x401, 22, 4, -1, -1, -1, -1, -1 };
  return &_ASPagerAdapter;
}

@end

void ASPagerAdapter_init(ASPagerAdapter *self) {
  NSObject_init(self);
  self->mObservable_ = new_ADDataSetObservable_init();
}

IOSObjectArray *ASPagerAdapter__Annotations$0() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaLangDeprecated() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *ASPagerAdapter__Annotations$1() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaLangDeprecated() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *ASPagerAdapter__Annotations$2() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaLangDeprecated() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *ASPagerAdapter__Annotations$3() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaLangDeprecated() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

IOSObjectArray *ASPagerAdapter__Annotations$4() {
  return [IOSObjectArray newArrayWithObjects:(id[]){ create_JavaLangDeprecated() } count:1 type:JavaLangAnnotationAnnotation_class_()];
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASPagerAdapter)
