...
#if !defined (ASPagerAdapter_) && (INCLUDE_ALL_PagerAdapter || defined(INCLUDE_ASPagerAdapter))
#define ASPagerAdapter_
 ...
 */
@interface ASPagerAdapter : NSObject
...
J2OBJC_EMPTY_STATIC_INIT(ASPagerAdapter)

inline jint ASPagerAdapter_get_POSITION_UNCHANGED(void);
#define ASPagerAdapter_POSITION_UNCHANGED -1
J2OBJC_STATIC_FIELD_CONSTANT(ASPagerAdapter, POSITION_UNCHANGED, jint)

inline jint ASPagerAdapter_get_POSITION_NONE(void);
#define ASPagerAdapter_POSITION_NONE -2
J2OBJC_STATIC_FIELD_CONSTANT(ASPagerAdapter, POSITION_NONE, jint)

FOUNDATION_EXPORT void ASPagerAdapter_init(ASPagerAdapter *self);

J2OBJC_TYPE_LITERAL_HEADER(ASPagerAdapter)

@compatibility_alias AndroidxViewpagerWidgetPagerAdapter ASPagerAdapter;
